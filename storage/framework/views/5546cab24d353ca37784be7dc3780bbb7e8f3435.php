			...
			<tbody>		
				...
				<tr>
					...
					<td> <a class="btn btn-outline-info" href="<?php echo e(url('admin/xulydangky/chitiet/')); ?>/<?php echo e($value->mssv); ?>/<?php echo e($value->MaPhong); ?>">
							...
							<a class="btn btn-outline-success" href="<?php echo e(url('admin/xulydangky/duyet/')); ?>/<?php echo e($value->MaDK); ?>/<?php echo e($value->MaPhong); ?>/<?php echo e($value->mssv); ?>">
                                <i class="fas fa-check"></i>
                                Duyệt
                        </a>
						<a class="btn btn-outline-danger" href="<?php echo e(url('admin/xulydangky/destroy/')); ?>/<?php echo e($value->MaDK); ?>" onclick="return confirm('Bạn chắc chắn muốn xóa yêu cầu đăng ký phòng này?')">
...
<?php echo $__env->make('admin/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\NienLuan\ktx\resources\views/admin/xulydangky.blade.php ENDPATH**/ ?>