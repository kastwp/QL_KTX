...
<head>
  ...
  <title>Login | User | KTX | CTU</title>
    ...
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo e(route('user.auth')); ?>" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name='email' placeholder="Mã Sinh Viên" required>
...
<?php /**PATH C:\xampp\htdocs\NienLuan\ktx\resources\views/user/welcome.blade.php ENDPATH**/ ?>